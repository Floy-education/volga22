...
alias elup="sudo systemctl start elasticsearch.service; sudo systemctl start kibana.service"
alias eldown="sudo systemctl stop elasticsearch.service; sudo systemctl stop kibana.service" 
